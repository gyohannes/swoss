  ...
  def create
    ...
    respond_to do |format|
      if @payment_type.save
        format.html { redirect_to payment_types_path, notice: 'Payment type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @payment_type.update(payment_type_params)
        format.html { redirect_to payment_types_path, notice: 'Payment type was successfully updated.' }
