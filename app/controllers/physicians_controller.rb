class PhysiciansController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @physician.save
        format.html { redirect_to physicians_path, notice: 'Physician was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @physician.update(physician_params)
        format.html { redirect_to physicians_path, notice: 'Physician was successfully updated.' }
  ...
  private
    ...
    def physician_params
      params.require(:physician).permit(:name, :hospital_id)
    end
end
