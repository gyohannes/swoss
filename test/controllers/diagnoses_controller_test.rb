...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { description: @diagnosis.description, name: @diagnosis.name } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { description: @diagnosis.description, name: @diagnosis.name } }
